...
//        };
    ...
    public void onClick(View v) {
        if (v == startImport) {
            ...
            AliyunSnapVideoParam mCropParam = new AliyunSnapVideoParam.Builder().setFrameRate(frameRate)//设置帧率
                    .setGop(gop)//设置关键帧间隔
                    ...
                    .setVideoCodec(mVideoCodec).build();
...
//
//                    path = data.getStringExtra(AlivcCropOutputParam.RESULT_KEY_OUTPUT_PARAM);
//
